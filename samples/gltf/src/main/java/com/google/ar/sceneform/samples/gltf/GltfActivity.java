...
public class GltfActivity extends AppCompatActivity {
    ...
    private AnchorNode prevAnchorNode = null;
    ...
    public void lineBetweenPoints(HitResult hitResult) {
        Anchor anchor = hitResult.createAnchor();
        AnchorNode anchorNode = new AnchorNode(anchor);
        prevAnchorNode = currAnchorNode;
        currAnchorNode = anchorNode;
        currAnchorNode.setParent(arFragment.getArSceneView().getScene());
        if (prevAnchorNode != null) {
            Vector3 point1 = currAnchorNode.getWorldPosition();
            Vector3 point2 = prevAnchorNode.getWorldPosition();
